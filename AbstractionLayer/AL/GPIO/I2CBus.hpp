...
namespace AL::GPIO
{
	...
	public:
		...
		// @throw AL::Exceptions::Exception
		template<typename T, size_t S = sizeof(T)>
		void Read(I2CAddress address, I2CRegister _register, T& value)
		{
			AL_ASSERT(IsOpen(), "I2CBus not open");
		...
		// @throw AL::Exceptions::Exception
		void Read(I2CAddress address, I2CRegister _register, void* lpBuffer, size_t size)
		{
			AL_ASSERT(IsOpen(), "I2CBus not open");
		...
		// @throw AL::Exceptions::Exception
		template<typename T, size_t S = sizeof(T)>
		void Write(I2CAddress address, I2CRegister _register, const T& value)
		{
			AL_ASSERT(IsOpen(), "I2CBus not open");
		...
		// @throw AL::Exceptions::Exception
		void Write(I2CAddress address, I2CRegister _register, const void* lpBuffer, size_t size)
		{
			AL_ASSERT(IsOpen(), "I2CBus not open");
...
// @throw AL::Exceptions::Exception
template<typename T, size_t S>
inline void AL::GPIO::I2CDevice::Read(I2CRegister _register, T& value)
{
	GetBus().Read<T, S>(
		GetAddress(),
		_register,
...
// @throw AL::Exceptions::Exception
inline void AL::GPIO::I2CDevice::Read(I2CRegister _register, void* lpBuffer, size_t size)
{
	GetBus().Read(
		GetAddress(),
		_register,
...
// @throw AL::Exceptions::Exception
template<typename T, size_t S>
inline void AL::GPIO::I2CDevice::Write(I2CRegister _register, const T& value)
{
	GetBus().Write<T, S>(
		GetAddress(),
		_register,
...
// @throw AL::Exceptions::Exception
inline void AL::GPIO::I2CDevice::Write(I2CRegister _register, const void* lpBuffer, size_t size)
{
	GetBus().Write(
		GetAddress(),
		_register,
